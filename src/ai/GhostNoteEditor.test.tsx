...
import { saveAiSettings, saveGhostCompletionEnabled } from './ai-settings'
import { requestGhostCompletion } from './ghost-completion'
import { GhostNoteEditor } from './GhostNoteEditor'

vi.mock('./ghost-completion', () => ({ requestGhostCompletion: vi.fn() }))
